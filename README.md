...
>这个方案适合像我一样经常到处跑并且需要旁路由的朋友，出门随身带一个软路由不方便也不现实，但是随身带一个旧手机就很轻巧了，就算没有局域网 WiFi ，开个手机热点也组成一个旁路由。即使没带电脑，也可以直接在手机上完成操作。
>
>当然这个肯定不适合高阶玩家，毕竟手机不是专门干网络路由的，速度和稳定性肯定不如软路由
>
> proxyDaemon使用的方案是不良林的这期视频：[【全网首发】 闲置安卓手机充当软路由，突破第三方 VPN 客户端设备限制，接管局域网所有设备上网数据实现全家科学上网，旁路网关、旁路由、透明代理、透明网关、网关代理、网关模式、代替 openwrt 软路由](https://youtu.be/r6nXCgYkXTQ?si=XRDxoHQlfYMLjWS_)
> 
>如果要想要7×24h就放在角落里使用，并且希望使用WebUI来切换节点，那这期不良林的视频可以帮到你：[【新版首发】最佳闲置安卓手机变身软路由方法，突破VPN客户端设备限制，实现全家科学上网，小白也能轻松上手，代替电视盒子的openwrt，旁路网关、旁路由、透明代理、透明网关](https://youtu.be/oRyjX44Bxw4?si=OBb3YU7e7q4yGCgT)
